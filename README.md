...
A modern AI-powered web application that analyzes resumes, matches them against job descriptions, and provides ATS-style feedback using Google Gemini AI.
